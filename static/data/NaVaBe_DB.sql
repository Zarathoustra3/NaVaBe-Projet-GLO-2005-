...
FLUSH PRIVILEGES;
/*On s'assure que les permissions entrent en vigueur*/
...
*/
ALTER USER 'Navabe_Project'@'localhost' IDENTIFIED WITH mysql_native_password BY '{Password}';
